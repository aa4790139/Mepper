...
import org.mepper.utils.ArrayUtil;
...
public class XMLReader implements MapReader{
	...
	private Map readMap(Element e) throws InstantiationException,
		...
		map.setExtension(getIntAttribute(e, "rows"), 
	...
	private BufferedImage getImage(Element e) {
		...
		int[] pixels= ArrayUtil.toIntArray(data);
		return ImageUtil.createImage(pixels, width, height);
	}
