...
public class LibraryDialog extends AppDialog {
	...
	private final ProjectManager project; 
        private AppResources r= AppManager.getResources();
    /** Creates new form LibraryDialog */
    public LibraryDialog(ProjectManager project,Application app) {
        ...
        managerTree.addTreeSelectionListener(new TreeSelectionListener() {
			...
			public void valueChanged(TreeSelectionEvent e) {
				...
				messager.setText(ResourcesMessager.getMessage(r));
			}
		});
    }
    
    private StorableResource getRoot(){
    	return manager.create(manager.getRoot()); 
    }
	...
	private void addLibrary(TreePath[] paths) {
		StorableResource r=project.getCurrentProject().getChildByID(ProjectManager.LIBRARY_SET_ID);
		for(TreePath p:paths){
    		if(p.getPathCount()<2){
    			continue;
    		}
    		LibraryResource lib=(LibraryResource) p.getPathComponent(1);
    		r.addChild(lib);
//    		project.addResourceChild(lib);
    	}
